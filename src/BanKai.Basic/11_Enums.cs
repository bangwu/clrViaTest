...
namespace BanKai.Basic
{
    ...
    public class Enums
    {
        ...
        public void should_be_able_to_compare_enums()
        {
            ...
            const bool expectedResultForBottomEqualsLeft = false;//true;
            const bool expectedResultForRightEqualsRight = true;//false;
        ...
        public void should_increase_the_integer_automatically()
        {
            ...
            const int leftValue = 0;//int.MinValue;
            const int rightValue = 1;//int.MinValue;
            const int topValue = 2;//int.MinValue;
            const int bottomValue = 3;//int.MinValue;
