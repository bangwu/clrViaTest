...
namespace BanKai.Basic
{
    ...
    public class Inheritance
    {
        ...
        public void should_throw_exception_if_it_is_not_castable()
        {
            ...
            // please change the variable value to fix the test.
            Type expectedExceptionType = typeof (InvalidCastException);//typeof(ArgumentException);
        ...
        public void should_call_default_constructor_of_base_class_when_call_derived_ctor_with_args()
        {
            ...
            // please change the variable value to fix the test.
            string expected = "InheritanceConstructorCallDemoClassBase::Ctor()" + System.Environment.NewLine + "InheritanceConstructorCallDemoClass::Ctor(int)" + System.Environment.NewLine;
        ...
        public void should_be_able_to_specify_which_ctor_of_current_class_to_call()
        {
            ...
            // please change the variable value to fix the test.
            string expected ="InheritanceConstructorCallDemoClassBase::Ctor()"+System.Environment.NewLine+"InheritanceConstructorCallDemoClass::Ctor(int)"+System.Environment.NewLine+ "InheritanceConstructorCallDemoClass::Ctor(int, string)"+System.Environment.NewLine;
