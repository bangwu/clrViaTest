...
namespace BanKai.Basic
{
    ...
    public class StringAndCharOperations
    {
        ...
        public void should_concat_string()
        {
            ...
            const string expectedResult = "Mr. Hall";//default(string);
        ...
        public void should_locate_certain_character_using_indexer()
        {
            ...
            const char expectedResult = 'i';//default (char);
        ...
        public void should_compare_string_value()
        {
            ...
            const bool expectedResult = true;//default(bool);
        ...
        public void should_use_equal_method_to_test_equaility_in_a_more_flexible_way()
        {
            ...
            var caseSensitiveComparison = StringComparison.InvariantCulture;//StringComparison.InvariantCultureIgnoreCase;
            var caseInsensitiveComparison = StringComparison.CurrentCultureIgnoreCase;//StringComparison.InvariantCulture;
